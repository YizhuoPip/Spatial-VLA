...
定义了 Open-X 身体化数据集的数据集混合及权重的注册表。每个数据集都关联有一个浮点数“采样权重”
"""
...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    "aloha_place_vegetable": [
        ("aloha_place_vegetable", 1.0),
    ],
    "aloha_place_green_vegetable": [
        ("aloha_place_green_vegetable", 1.0),
    ],
    "aloha_place_red_vegetable": [
        ("aloha_place_red_vegetable", 1.0),
    ],
    "aloha_place_yellow_vegetable": [
        ("aloha_place_yellow_vegetable", 1.0),
    ],
    "aloha_place_zero_floor_block": [
        ("aloha_place_zero_floor_block", 1.0),
    ],
    "aloha_place_one_floor_block": [
        ("aloha_place_one_floor_block", 1.0),
    ],
    "aloha_place_two_floor_block": [
        ("aloha_place_two_floor_block", 1.0),
    ],
    "aloha_stack_transparent_glass": [
        ("aloha_stack_transparent_glass", 1.0),
    ],
