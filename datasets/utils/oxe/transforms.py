...
from datasets.utils.oxe.utils.droid_utils import droid_baseact_transform, droid_finetuning_transform
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "aloha_place_vegetable": aloha_dataset_transform,
    "aloha_place_green_vegetable": aloha_dataset_transform,
    "aloha_place_red_vegetable": aloha_dataset_transform,
    "aloha_place_yellow_vegetable": aloha_dataset_transform,
    "aloha_place_zero_floor_block": aloha_dataset_transform,
    "aloha_place_one_floor_block": aloha_dataset_transform,
    "aloha_place_two_floor_block": aloha_dataset_transform,
    "aloha_stack_transparent_glass": aloha_dataset_transform,
