...
from models.projectors import NoisyActionProjector, ProprioProjector
from dataset.utils.constants import (
    ACTION_DIM,
    ACTION_PROPRIO_NORMALIZATION_TYPE,
)
from dataset.utils.rlds.utils.data_utils import NormalizationType
...
def get_action_head(cfg: Any, llm_dim: int):
    ...
    if cfg.use_full_injection:
        ...
        raise ValueError("Either use_l1_regression or use_diffusion or use_full_injection must be True")
