...
from eval.utils.openvla_utils import (
    get_action_head,
...
from eval.utils.robot_utils import (
    DATE_TIME,
    get_action,
...
from dataset.utils.constants import NUM_ACTIONS_CHUNK
...
class GenerateConfig:
    ...
    # fmt: on
    save_version: str = "spatialvla"                # version of 
...
def initialize_model(cfg: GenerateConfig):
    ...
    action_head = None
    if cfg.use_l1_regression or cfg.use_full_injection:
